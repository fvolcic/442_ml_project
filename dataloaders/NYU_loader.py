...
def get_dataloaders(batch_size=16, output_image_width = 512, output_image_height = 512, custom_transforms=None) -> Tuple[DataLoader, DataLoader]:
    """
    ...
    train = _NYUv2(root=FOLDER_ROOT, train=True, download=True, rgb_transform=t, seg_transform=t, sn_transform=t, depth_transform=t)
    test = _NYUv2(root=FOLDER_ROOT, train=False, download=True, rgb_transform=t, seg_transform=t, sn_transform=t, depth_transform=t)
